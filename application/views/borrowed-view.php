      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li><a href="<?php echo site_url('Welcome/board/');?>">Daftar Buku </a></li>
            <li class="active"><a href="borrowed">Yang anda Pinjam <span class="sr-only">(current)</span></a></li>
          </ul>
        </div>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="row placeholders">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <?php foreach($peminjaman as $brow){?>
                <tr>
                  ...
                  <td><a href="<?php echo site_url('Welcome/bringback/'.$brow->ISBN);?>">Kembalikan</a></td>
                </tr>
                <?php }?>
              </tbody>
            </table>
